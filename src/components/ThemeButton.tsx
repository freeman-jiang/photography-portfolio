  ...
  return (
    <div className="flex lg:justify-center items-center gap-4 lg:flex-row-reverse">
      <Button
        ...
        className="p-2 hover:bg-inherit size-12 dark:bg-stone-800 shadow-lg shadow-yellow-300/50 hover:shadow-yellow-300/90 dark:shadow-blue-500/65 dark:hover:shadow-blue-500/90 transition-shadow duration-300 hover:bg-stone-50"
      >
